...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        "about.txt": "Hey! I am Lavish Garg currently in 3rd year of B.Tech.\nI am a: \n->Web Developer\n->Security Researcher\n->Pentester\n->Blockchain Developer \n->Software Developer.\n\nIf you want to give me some awesome ideas related to my portfolio website feel free to email me: lavishgarg2018@gmail.com",
        "getting_started.txt": "->This terminal base portfolio is just basic portfolio to get quick glace of what I am.\n->For detail dive into portfolio check out portfolio.txt.\n->You can also check my blogs from blogs.txt.\n->These files are also used to be listed on the sidenav.\n->You can also check my Linkedin profile using linkedin.txt.\n->For further enquiry you can also contact me through e-mail given in contact.txt.\n",
        "contact.txt": "lavishgarg2018@gmail.com",
        "blog.txt":"https://lavishgarg.medium.com/",
        "linkedin.txt": "https://www.linkedin.com/in/lavish-garg-42b200192/",
        "portfolio.txt": "https://lavish-garg.github.io/lavishgarg2.github.io/"
    };
    return {
        getInstance: function (options) {
            instance === void 0 && (instance = new Singleton(options));
